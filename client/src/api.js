...
export const api = {
  ...
  setTentative: (artistId, date, slotLabel) => req("POST", "/admin/recommend/tentative", { artistId, date, slotLabel }),
  clearTentative: (artistId, date) => req("DELETE", "/admin/recommend/tentative", { artistId, date }),
