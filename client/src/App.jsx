...
function DraftPanel({ d, flash, onDismiss, onToggleSent, api: dpApi, onSent }) {
  ...
  return (
    <div style={{ ...st.card, borderLeft: `3px solid ${T.green}`, marginTop: 4 }}>
      ...
      <textarea value={body} onChange={(e) => setBody(e.target.value)} rows={12} style={{ ...st.input, width: "100%", boxSizing: "border-box", resize: "vertical", marginTop: 8, fontSize: 13, lineHeight: 1.5 }} />
...
const st = {
  ...
  input: {
    ...
    padding: "10px 12px", color: T.cream, fontSize: 14, fontFamily: "'Karla', sans-serif",
